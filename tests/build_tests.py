...
class TestPopuliBuild(unittest.TestCase):
    ...
    def test_get_single_command_parameter(self):
        ...
        self.assertEqual(
            parameters[0].comment, "The numeric ID of the payment you're interested in."
        )
...
<td>Yes</td>
        ...
        self.assertEqual(
            commands[0].parameters[0].comment,
            "The numeric ID of the payment you're interested in.",
        )
